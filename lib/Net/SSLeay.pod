...
defined by the underlaying OpenSSL or LibreSSL library.
...
underlaying library is OpenSSL:
...
check that the underlaying library is LibreSSL and it's recent enough:
...
=for start_constants
    ...
    ASN1_STRFLGS_ESC_CTRL                   OP_ALL
    ASN1_STRFLGS_ESC_MSB                    OP_ALLOW_NO_DHE_KEX
    ASN1_STRFLGS_ESC_QUOTE                  OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION
    ASN1_STRFLGS_RFC2253                    OP_CIPHER_SERVER_PREFERENCE
    CB_ACCEPT_EXIT                          OP_CISCO_ANYCONNECT
    CB_ACCEPT_LOOP                          OP_COOKIE_EXCHANGE
    CB_ALERT                                OP_CRYPTOPRO_TLSEXT_BUG
    CB_CONNECT_EXIT                         OP_DONT_INSERT_EMPTY_FRAGMENTS
    CB_CONNECT_LOOP                         OP_ENABLE_MIDDLEBOX_COMPAT
    CB_EXIT                                 OP_EPHEMERAL_RSA
    CB_HANDSHAKE_DONE                       OP_LEGACY_SERVER_CONNECT
    CB_HANDSHAKE_START                      OP_MICROSOFT_BIG_SSLV3_BUFFER
    CB_LOOP                                 OP_MICROSOFT_SESS_ID_BUG
    CB_READ                                 OP_MSIE_SSLV2_RSA_PADDING
    CB_READ_ALERT                           OP_NETSCAPE_CA_DN_BUG
    CB_WRITE                                OP_NETSCAPE_CHALLENGE_BUG
    CB_WRITE_ALERT                          OP_NETSCAPE_DEMO_CIPHER_CHANGE_BUG
    ERROR_NONE                              OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG
    ERROR_SSL                               OP_NON_EXPORT_FIRST
    ERROR_SYSCALL                           OP_NO_ANTI_REPLAY
    ERROR_WANT_ACCEPT                       OP_NO_CLIENT_RENEGOTIATION
    ERROR_WANT_CONNECT                      OP_NO_COMPRESSION
    ERROR_WANT_READ                         OP_NO_ENCRYPT_THEN_MAC
    ERROR_WANT_WRITE                        OP_NO_QUERY_MTU
    ERROR_WANT_X509_LOOKUP                  OP_NO_RENEGOTIATION
    ERROR_ZERO_RETURN                       OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION
    EVP_PKS_DSA                             OP_NO_SSL_MASK
    EVP_PKS_EC                              OP_NO_SSLv2
    EVP_PKS_RSA                             OP_NO_SSLv3
    EVP_PKT_ENC                             OP_NO_TICKET
    EVP_PKT_EXCH                            OP_NO_TLSv1
    EVP_PKT_EXP                             OP_NO_TLSv1_1
    EVP_PKT_SIGN                            OP_NO_TLSv1_2
    EVP_PK_DH                               OP_NO_TLSv1_3
    EVP_PK_DSA                              OP_PKCS1_CHECK_1
    EVP_PK_EC                               OP_PKCS1_CHECK_2
    EVP_PK_RSA                              OP_PRIORITIZE_CHACHA
    FILETYPE_ASN1                           OP_SAFARI_ECDHE_ECDSA_BUG
    FILETYPE_PEM                            OP_SINGLE_DH_USE
    F_CLIENT_CERTIFICATE                    OP_SINGLE_ECDH_USE
    F_CLIENT_HELLO                          OP_SSLEAY_080_CLIENT_DH_BUG
    F_CLIENT_MASTER_KEY                     OP_SSLREF2_REUSE_CERT_TYPE_BUG
    F_D2I_SSL_SESSION                       OP_TLSEXT_PADDING
    F_GET_CLIENT_FINISHED                   OP_TLS_BLOCK_PADDING_BUG
    F_GET_CLIENT_HELLO                      OP_TLS_D5_BUG
    F_GET_CLIENT_MASTER_KEY                 OP_TLS_ROLLBACK_BUG
    F_GET_SERVER_FINISHED                   READING
    F_GET_SERVER_HELLO                      RECEIVED_SHUTDOWN
    F_GET_SERVER_VERIFY                     RSA_3
    F_I2D_SSL_SESSION                       RSA_F4
    F_READ_N                                R_BAD_AUTHENTICATION_TYPE
    F_REQUEST_CERTIFICATE                   R_BAD_CHECKSUM
    F_SERVER_HELLO                          R_BAD_MAC_DECODE
    F_SSL_CERT_NEW                          R_BAD_RESPONSE_ARGUMENT
    F_SSL_GET_NEW_SESSION                   R_BAD_SSL_FILETYPE
    F_SSL_NEW                               R_BAD_SSL_SESSION_ID_LENGTH
    F_SSL_READ                              R_BAD_STATE
    F_SSL_RSA_PRIVATE_DECRYPT               R_BAD_WRITE_RETRY
    F_SSL_RSA_PUBLIC_ENCRYPT                R_CHALLENGE_IS_DIFFERENT
    F_SSL_SESSION_NEW                       R_CIPHER_TABLE_SRC_ERROR
    F_SSL_SESSION_PRINT_FP                  R_INVALID_CHALLENGE_LENGTH
    F_SSL_SET_FD                            R_NO_CERTIFICATE_SET
    F_SSL_SET_RFD                           R_NO_CERTIFICATE_SPECIFIED
    F_SSL_SET_WFD                           R_NO_CIPHER_LIST
    F_SSL_USE_CERTIFICATE                   R_NO_CIPHER_MATCH
    F_SSL_USE_CERTIFICATE_ASN1              R_NO_PRIVATEKEY
    F_SSL_USE_CERTIFICATE_FILE              R_NO_PUBLICKEY
    F_SSL_USE_PRIVATEKEY                    R_NULL_SSL_CTX
    F_SSL_USE_PRIVATEKEY_ASN1               R_PEER_DID_NOT_RETURN_A_CERTIFICATE
    F_SSL_USE_PRIVATEKEY_FILE               R_PEER_ERROR
    F_SSL_USE_RSAPRIVATEKEY                 R_PEER_ERROR_CERTIFICATE
    F_SSL_USE_RSAPRIVATEKEY_ASN1            R_PEER_ERROR_NO_CIPHER
    F_SSL_USE_RSAPRIVATEKEY_FILE            R_PEER_ERROR_UNSUPPORTED_CERTIFICATE_TYPE
    F_WRITE_PENDING                         R_PUBLIC_KEY_ENCRYPT_ERROR
    GEN_DIRNAME                             R_PUBLIC_KEY_IS_NOT_RSA
    GEN_DNS                                 R_READ_WRONG_PACKET_TYPE
    GEN_EDIPARTY                            R_SHORT_READ
    GEN_EMAIL                               R_SSL_SESSION_ID_IS_DIFFERENT
    GEN_IPADD                               R_UNABLE_TO_EXTRACT_PUBLIC_KEY
    GEN_OTHERNAME                           R_UNKNOWN_REMOTE_ERROR_TYPE
    GEN_RID                                 R_UNKNOWN_STATE
    GEN_URI                                 R_X509_LIB
    GEN_X400                                SENT_SHUTDOWN
    LIBRESSL_VERSION_NUMBER                 SESSION_ASN1_VERSION
    MBSTRING_ASC                            SESS_CACHE_BOTH
    MBSTRING_BMP                            SESS_CACHE_CLIENT
    MBSTRING_FLAG                           SESS_CACHE_NO_AUTO_CLEAR
    MBSTRING_UNIV                           SESS_CACHE_NO_INTERNAL
    MBSTRING_UTF8                           SESS_CACHE_NO_INTERNAL_LOOKUP
    MIN_RSA_MODULUS_LENGTH_IN_BYTES         SESS_CACHE_NO_INTERNAL_STORE
    MODE_ACCEPT_MOVING_WRITE_BUFFER         SESS_CACHE_OFF
    MODE_AUTO_RETRY                         SESS_CACHE_SERVER
    MODE_ENABLE_PARTIAL_WRITE               SSL2_MT_CLIENT_CERTIFICATE
    MODE_RELEASE_BUFFERS                    SSL2_MT_CLIENT_FINISHED
    NID_OCSP_sign                           SSL2_MT_CLIENT_HELLO
    NID_SMIMECapabilities                   SSL2_MT_CLIENT_MASTER_KEY
    NID_X500                                SSL2_MT_ERROR
    NID_X509                                SSL2_MT_REQUEST_CERTIFICATE
    NID_ad_OCSP                             SSL2_MT_SERVER_FINISHED
    NID_ad_ca_issuers                       SSL2_MT_SERVER_HELLO
    NID_algorithm                           SSL2_MT_SERVER_VERIFY
    NID_authority_key_identifier            SSL2_VERSION
    NID_basic_constraints                   SSL3_MT_CCS
    NID_bf_cbc                              SSL3_MT_CERTIFICATE
    NID_bf_cfb64                            SSL3_MT_CERTIFICATE_REQUEST
    NID_bf_ecb                              SSL3_MT_CERTIFICATE_STATUS
    NID_bf_ofb64                            SSL3_MT_CERTIFICATE_URL
    NID_cast5_cbc                           SSL3_MT_CERTIFICATE_VERIFY
    NID_cast5_cfb64                         SSL3_MT_CHANGE_CIPHER_SPEC
    NID_cast5_ecb                           SSL3_MT_CLIENT_HELLO
    NID_cast5_ofb64                         SSL3_MT_CLIENT_KEY_EXCHANGE
    NID_certBag                             SSL3_MT_ENCRYPTED_EXTENSIONS
    NID_certificate_policies                SSL3_MT_END_OF_EARLY_DATA
    NID_client_auth                         SSL3_MT_FINISHED
    NID_code_sign                           SSL3_MT_HELLO_REQUEST
    NID_commonName                          SSL3_MT_KEY_UPDATE
    NID_countryName                         SSL3_MT_MESSAGE_HASH
    NID_crlBag                              SSL3_MT_NEWSESSION_TICKET
    NID_crl_distribution_points             SSL3_MT_NEXT_PROTO
    NID_crl_number                          SSL3_MT_SERVER_DONE
    NID_crl_reason                          SSL3_MT_SERVER_HELLO
    NID_delta_crl                           SSL3_MT_SERVER_KEY_EXCHANGE
    NID_des_cbc                             SSL3_MT_SUPPLEMENTAL_DATA
    NID_des_cfb64                           SSL3_RT_ALERT
    NID_des_ecb                             SSL3_RT_APPLICATION_DATA
    NID_des_ede                             SSL3_RT_CHANGE_CIPHER_SPEC
    NID_des_ede3                            SSL3_RT_HANDSHAKE
    NID_des_ede3_cbc                        SSL3_RT_HEADER
    NID_des_ede3_cfb64                      SSL3_RT_INNER_CONTENT_TYPE
    NID_des_ede3_ofb64                      SSL3_VERSION
    NID_des_ede_cbc                         SSLEAY_BUILT_ON
    NID_des_ede_cfb64                       SSLEAY_CFLAGS
    NID_des_ede_ofb64                       SSLEAY_DIR
    NID_des_ofb64                           SSLEAY_PLATFORM
    NID_description                         SSLEAY_VERSION
    NID_desx_cbc                            ST_ACCEPT
    NID_dhKeyAgreement                      ST_BEFORE
    NID_dnQualifier                         ST_CONNECT
    NID_dsa                                 ST_INIT
    NID_dsaWithSHA                          ST_OK
    NID_dsaWithSHA1                         ST_READ_BODY
    NID_dsaWithSHA1_2                       ST_READ_HEADER
    NID_dsa_2                               TLS1_1_VERSION
    NID_email_protect                       TLS1_2_VERSION
    NID_ext_key_usage                       TLS1_3_VERSION
    NID_ext_req                             TLS1_VERSION
    NID_friendlyName                        TLSEXT_STATUSTYPE_ocsp
    ...
    NID_mdc2WithRSA                         X509_TRUST_EMAIL
    NID_ms_code_com                         X509_TRUST_OBJECT_SIGN
    NID_ms_code_ind                         X509_TRUST_OCSP_REQUEST
    NID_ms_ctl_sign                         X509_TRUST_OCSP_SIGN
    NID_ms_efs                              X509_TRUST_SSL_CLIENT
    NID_ms_ext_req                          X509_TRUST_SSL_SERVER
    NID_ms_sgc                              X509_TRUST_TSA
    NID_name                                X509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH
    NID_netscape                            X509_V_ERR_AKID_SKID_MISMATCH
    NID_netscape_base_url                   X509_V_ERR_APPLICATION_VERIFICATION
    NID_netscape_ca_policy_url              X509_V_ERR_CA_KEY_TOO_SMALL
    NID_netscape_ca_revocation_url          X509_V_ERR_CA_MD_TOO_WEAK
    NID_netscape_cert_extension             X509_V_ERR_CERT_CHAIN_TOO_LONG
    NID_netscape_cert_sequence              X509_V_ERR_CERT_HAS_EXPIRED
    NID_netscape_cert_type                  X509_V_ERR_CERT_NOT_YET_VALID
    NID_netscape_comment                    X509_V_ERR_CERT_REJECTED
    NID_netscape_data_type                  X509_V_ERR_CERT_REVOKED
    NID_netscape_renewal_url                X509_V_ERR_CERT_SIGNATURE_FAILURE
    NID_netscape_revocation_url             X509_V_ERR_CERT_UNTRUSTED
    NID_netscape_ssl_server_name            X509_V_ERR_CRL_HAS_EXPIRED
    NID_ns_sgc                              X509_V_ERR_CRL_NOT_YET_VALID
    NID_organizationName                    X509_V_ERR_CRL_PATH_VALIDATION_ERROR
    NID_organizationalUnitName              X509_V_ERR_CRL_SIGNATURE_FAILURE
    NID_pbeWithMD2AndDES_CBC                X509_V_ERR_DANE_NO_MATCH
    NID_pbeWithMD2AndRC2_CBC                X509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT
    NID_pbeWithMD5AndCast5_CBC              X509_V_ERR_DIFFERENT_CRL_SCOPE
    NID_pbeWithMD5AndDES_CBC                X509_V_ERR_EE_KEY_TOO_SMALL
    NID_pbeWithMD5AndRC2_CBC                X509_V_ERR_EMAIL_MISMATCH
    NID_pbeWithSHA1AndDES_CBC               X509_V_ERR_ERROR_IN_CERT_NOT_AFTER_FIELD
    NID_pbeWithSHA1AndRC2_CBC               X509_V_ERR_ERROR_IN_CERT_NOT_BEFORE_FIELD
    NID_pbe_WithSHA1And128BitRC2_CBC        X509_V_ERR_ERROR_IN_CRL_LAST_UPDATE_FIELD
    NID_pbe_WithSHA1And128BitRC4            X509_V_ERR_ERROR_IN_CRL_NEXT_UPDATE_FIELD
    NID_pbe_WithSHA1And2_Key_TripleDES_CBC  X509_V_ERR_EXCLUDED_VIOLATION
    NID_pbe_WithSHA1And3_Key_TripleDES_CBC  X509_V_ERR_HOSTNAME_MISMATCH
    NID_pbe_WithSHA1And40BitRC2_CBC         X509_V_ERR_INVALID_CA
    NID_pbe_WithSHA1And40BitRC4             X509_V_ERR_INVALID_CALL
    NID_pbes2                               X509_V_ERR_INVALID_EXTENSION
    NID_pbmac1                              X509_V_ERR_INVALID_NON_CA
    NID_pkcs                                X509_V_ERR_INVALID_POLICY_EXTENSION
    NID_pkcs3                               X509_V_ERR_INVALID_PURPOSE
    NID_pkcs7                               X509_V_ERR_IP_ADDRESS_MISMATCH
    ...
    NID_pkcs7_enveloped                     X509_V_ERR_NO_EXPLICIT_POLICY
    NID_pkcs7_signed                        X509_V_ERR_NO_VALID_SCTS
    NID_pkcs7_signedAndEnveloped            X509_V_ERR_OCSP_CERT_UNKNOWN
    NID_pkcs8ShroudedKeyBag                 X509_V_ERR_OCSP_VERIFY_FAILED
    NID_pkcs9                               X509_V_ERR_OCSP_VERIFY_NEEDED
    NID_pkcs9_challengePassword             X509_V_ERR_OUT_OF_MEM
    NID_pkcs9_contentType                   X509_V_ERR_PATH_LENGTH_EXCEEDED
    NID_pkcs9_countersignature              X509_V_ERR_PATH_LOOP
    NID_pkcs9_emailAddress                  X509_V_ERR_PERMITTED_VIOLATION
    NID_pkcs9_extCertAttributes             X509_V_ERR_PROXY_CERTIFICATES_NOT_ALLOWED
    NID_pkcs9_messageDigest                 X509_V_ERR_PROXY_PATH_LENGTH_EXCEEDED
    NID_pkcs9_signingTime                   X509_V_ERR_PROXY_SUBJECT_NAME_VIOLATION
    NID_pkcs9_unstructuredAddress           X509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN
    NID_pkcs9_unstructuredName              X509_V_ERR_STORE_LOOKUP
    NID_private_key_usage_period            X509_V_ERR_SUBJECT_ISSUER_MISMATCH
    NID_rc2_40_cbc                          X509_V_ERR_SUBTREE_MINMAX
    NID_rc2_64_cbc                          X509_V_ERR_SUITE_B_CANNOT_SIGN_P_384_WITH_P_256
    NID_rc2_cbc                             X509_V_ERR_SUITE_B_INVALID_ALGORITHM
    NID_rc2_cfb64                           X509_V_ERR_SUITE_B_INVALID_CURVE
    NID_rc2_ecb                             X509_V_ERR_SUITE_B_INVALID_SIGNATURE_ALGORITHM
    NID_rc2_ofb64                           X509_V_ERR_SUITE_B_INVALID_VERSION
    NID_rc4                                 X509_V_ERR_SUITE_B_LOS_NOT_ALLOWED
    NID_rc4_40                              X509_V_ERR_UNABLE_TO_DECODE_ISSUER_PUBLIC_KEY
    NID_rc5_cbc                             X509_V_ERR_UNABLE_TO_DECRYPT_CERT_SIGNATURE
    NID_rc5_cfb64                           X509_V_ERR_UNABLE_TO_DECRYPT_CRL_SIGNATURE
    NID_rc5_ecb                             X509_V_ERR_UNABLE_TO_GET_CRL
    NID_rc5_ofb64                           X509_V_ERR_UNABLE_TO_GET_CRL_ISSUER
    NID_ripemd160                           X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT
    NID_ripemd160WithRSA                    X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY
    NID_rle_compression                     X509_V_ERR_UNABLE_TO_VERIFY_LEAF_SIGNATURE
    NID_rsa                                 X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION
    NID_rsaEncryption                       X509_V_ERR_UNHANDLED_CRITICAL_EXTENSION
    NID_rsadsi                              X509_V_ERR_UNNESTED_RESOURCE
    NID_safeContentsBag                     X509_V_ERR_UNSPECIFIED
    NID_sdsiCertificate                     X509_V_ERR_UNSUPPORTED_CONSTRAINT_SYNTAX
    NID_secretBag                           X509_V_ERR_UNSUPPORTED_CONSTRAINT_TYPE
    NID_serialNumber                        X509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE
    NID_server_auth                         X509_V_ERR_UNSUPPORTED_NAME_SYNTAX
    NID_sha                                 X509_V_FLAG_ALLOW_PROXY_CERTS
    NID_sha1                                X509_V_FLAG_CB_ISSUER_CHECK
    NID_sha1WithRSA                         X509_V_FLAG_CHECK_SS_SIGNATURE
    NID_sha1WithRSAEncryption               X509_V_FLAG_CRL_CHECK
    NID_shaWithRSAEncryption                X509_V_FLAG_CRL_CHECK_ALL
    NID_stateOrProvinceName                 X509_V_FLAG_EXPLICIT_POLICY
    NID_subject_alt_name                    X509_V_FLAG_EXTENDED_CRL_SUPPORT
    NID_subject_key_identifier              X509_V_FLAG_IGNORE_CRITICAL
    NID_surname                             X509_V_FLAG_INHIBIT_ANY
    NID_sxnet                               X509_V_FLAG_INHIBIT_MAP
    NID_time_stamp                          X509_V_FLAG_LEGACY_VERIFY
    NID_title                               X509_V_FLAG_NOTIFY_POLICY
    NID_undef                               X509_V_FLAG_NO_ALT_CHAINS
    NID_uniqueIdentifier                    X509_V_FLAG_NO_CHECK_TIME
    NID_x509Certificate                     X509_V_FLAG_PARTIAL_CHAIN
    NID_x509Crl                             X509_V_FLAG_POLICY_CHECK
    NID_zlib_compression                    X509_V_FLAG_POLICY_MASK
    NOTHING                                 X509_V_FLAG_SUITEB_128_LOS
    OCSP_RESPONSE_STATUS_INTERNALERROR      X509_V_FLAG_SUITEB_128_LOS_ONLY
    OCSP_RESPONSE_STATUS_MALFORMEDREQUEST   X509_V_FLAG_SUITEB_192_LOS
    OCSP_RESPONSE_STATUS_SIGREQUIRED        X509_V_FLAG_TRUSTED_FIRST
    OCSP_RESPONSE_STATUS_SUCCESSFUL         X509_V_FLAG_USE_CHECK_TIME
    OCSP_RESPONSE_STATUS_TRYLATER           X509_V_FLAG_USE_DELTAS
    OCSP_RESPONSE_STATUS_UNAUTHORIZED       X509_V_FLAG_X509_STRICT
    OPENSSL_BUILT_ON                        X509_V_OK
    OPENSSL_CFLAGS                          XN_FLAG_COMPAT
    OPENSSL_CPU_INFO                        XN_FLAG_DN_REV
    OPENSSL_DIR                             XN_FLAG_DUMP_UNKNOWN_FIELDS
    OPENSSL_ENGINES_DIR                     XN_FLAG_FN_ALIGN
    OPENSSL_FULL_VERSION_STRING             XN_FLAG_FN_LN
    OPENSSL_INFO_CONFIG_DIR                 XN_FLAG_FN_MASK
    OPENSSL_INFO_CPU_SETTINGS               XN_FLAG_FN_NONE
    OPENSSL_INFO_DIR_FILENAME_SEPARATOR     XN_FLAG_FN_OID
    OPENSSL_INFO_DSO_EXTENSION              XN_FLAG_FN_SN
    OPENSSL_INFO_ENGINES_DIR                XN_FLAG_MULTILINE
    OPENSSL_INFO_LIST_SEPARATOR             XN_FLAG_ONELINE
    OPENSSL_INFO_MODULES_DIR                XN_FLAG_RFC2253
    OPENSSL_INFO_SEED_SOURCE                XN_FLAG_SEP_COMMA_PLUS
    OPENSSL_MODULES_DIR                     XN_FLAG_SEP_CPLUS_SPC
    OPENSSL_PLATFORM                        XN_FLAG_SEP_MASK
    OPENSSL_VERSION                         XN_FLAG_SEP_MULTILINE
    OPENSSL_VERSION_NUMBER                  XN_FLAG_SEP_SPLUS_SPC
    OPENSSL_VERSION_STRING                  XN_FLAG_SPC_EQ
