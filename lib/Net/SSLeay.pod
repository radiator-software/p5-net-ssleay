...
=for start_constants
    ...
    ASN1_STRFLGS_ESC_CTRL                   OP_CISCO_ANYCONNECT
    ASN1_STRFLGS_ESC_MSB                    OP_COOKIE_EXCHANGE
    ASN1_STRFLGS_ESC_QUOTE                  OP_CRYPTOPRO_TLSEXT_BUG
    ASN1_STRFLGS_RFC2253                    OP_DONT_INSERT_EMPTY_FRAGMENTS
    CB_ACCEPT_EXIT                          OP_ENABLE_MIDDLEBOX_COMPAT
    CB_ACCEPT_LOOP                          OP_EPHEMERAL_RSA
    CB_ALERT                                OP_LEGACY_SERVER_CONNECT
    CB_CONNECT_EXIT                         OP_MICROSOFT_BIG_SSLV3_BUFFER
    CB_CONNECT_LOOP                         OP_MICROSOFT_SESS_ID_BUG
    CB_EXIT                                 OP_MSIE_SSLV2_RSA_PADDING
    CB_HANDSHAKE_DONE                       OP_NETSCAPE_CA_DN_BUG
    CB_HANDSHAKE_START                      OP_NETSCAPE_CHALLENGE_BUG
    CB_LOOP                                 OP_NETSCAPE_DEMO_CIPHER_CHANGE_BUG
    CB_READ                                 OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG
    CB_READ_ALERT                           OP_NON_EXPORT_FIRST
    CB_WRITE                                OP_NO_ANTI_REPLAY
    CB_WRITE_ALERT                          OP_NO_CLIENT_RENEGOTIATION
    ERROR_NONE                              OP_NO_COMPRESSION
    ERROR_SSL                               OP_NO_ENCRYPT_THEN_MAC
    ERROR_SYSCALL                           OP_NO_QUERY_MTU
    ERROR_WANT_ACCEPT                       OP_NO_RENEGOTIATION
    ERROR_WANT_CONNECT                      OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION
    ERROR_WANT_READ                         OP_NO_SSL_MASK
    ERROR_WANT_WRITE                        OP_NO_SSLv2
    ERROR_WANT_X509_LOOKUP                  OP_NO_SSLv3
    ERROR_ZERO_RETURN                       OP_NO_TICKET
    EVP_PKS_DSA                             OP_NO_TLSv1
    EVP_PKS_EC                              OP_NO_TLSv1_1
    EVP_PKS_RSA                             OP_NO_TLSv1_2
    EVP_PKT_ENC                             OP_NO_TLSv1_3
    EVP_PKT_EXCH                            OP_PKCS1_CHECK_1
    EVP_PKT_EXP                             OP_PKCS1_CHECK_2
    EVP_PKT_SIGN                            OP_PRIORITIZE_CHACHA
    EVP_PK_DH                               OP_SAFARI_ECDHE_ECDSA_BUG
    EVP_PK_DSA                              OP_SINGLE_DH_USE
    EVP_PK_EC                               OP_SINGLE_ECDH_USE
    EVP_PK_RSA                              OP_SSLEAY_080_CLIENT_DH_BUG
    FILETYPE_ASN1                           OP_SSLREF2_REUSE_CERT_TYPE_BUG
    FILETYPE_PEM                            OP_TLSEXT_PADDING
    F_CLIENT_CERTIFICATE                    OP_TLS_BLOCK_PADDING_BUG
    F_CLIENT_HELLO                          OP_TLS_D5_BUG
    F_CLIENT_MASTER_KEY                     OP_TLS_ROLLBACK_BUG
    F_D2I_SSL_SESSION                       READING
    F_GET_CLIENT_FINISHED                   RECEIVED_SHUTDOWN
    F_GET_CLIENT_HELLO                      RSA_3
    F_GET_CLIENT_MASTER_KEY                 RSA_F4
    F_GET_SERVER_FINISHED                   R_BAD_AUTHENTICATION_TYPE
    F_GET_SERVER_HELLO                      R_BAD_CHECKSUM
    F_GET_SERVER_VERIFY                     R_BAD_MAC_DECODE
    F_I2D_SSL_SESSION                       R_BAD_RESPONSE_ARGUMENT
    F_READ_N                                R_BAD_SSL_FILETYPE
    F_REQUEST_CERTIFICATE                   R_BAD_SSL_SESSION_ID_LENGTH
    F_SERVER_HELLO                          R_BAD_STATE
    F_SSL_CERT_NEW                          R_BAD_WRITE_RETRY
    F_SSL_GET_NEW_SESSION                   R_CHALLENGE_IS_DIFFERENT
    F_SSL_NEW                               R_CIPHER_TABLE_SRC_ERROR
    F_SSL_READ                              R_INVALID_CHALLENGE_LENGTH
    F_SSL_RSA_PRIVATE_DECRYPT               R_NO_CERTIFICATE_SET
    F_SSL_RSA_PUBLIC_ENCRYPT                R_NO_CERTIFICATE_SPECIFIED
    F_SSL_SESSION_NEW                       R_NO_CIPHER_LIST
    F_SSL_SESSION_PRINT_FP                  R_NO_CIPHER_MATCH
    F_SSL_SET_FD                            R_NO_PRIVATEKEY
    F_SSL_SET_RFD                           R_NO_PUBLICKEY
    F_SSL_SET_WFD                           R_NULL_SSL_CTX
    F_SSL_USE_CERTIFICATE                   R_PEER_DID_NOT_RETURN_A_CERTIFICATE
    F_SSL_USE_CERTIFICATE_ASN1              R_PEER_ERROR
    F_SSL_USE_CERTIFICATE_FILE              R_PEER_ERROR_CERTIFICATE
    F_SSL_USE_PRIVATEKEY                    R_PEER_ERROR_NO_CIPHER
    F_SSL_USE_PRIVATEKEY_ASN1               R_PEER_ERROR_UNSUPPORTED_CERTIFICATE_TYPE
    F_SSL_USE_PRIVATEKEY_FILE               R_PUBLIC_KEY_ENCRYPT_ERROR
    F_SSL_USE_RSAPRIVATEKEY                 R_PUBLIC_KEY_IS_NOT_RSA
    F_SSL_USE_RSAPRIVATEKEY_ASN1            R_READ_WRONG_PACKET_TYPE
    F_SSL_USE_RSAPRIVATEKEY_FILE            R_SHORT_READ
    F_WRITE_PENDING                         R_SSL_SESSION_ID_IS_DIFFERENT
    GEN_DIRNAME                             R_UNABLE_TO_EXTRACT_PUBLIC_KEY
    GEN_DNS                                 R_UNKNOWN_REMOTE_ERROR_TYPE
    GEN_EDIPARTY                            R_UNKNOWN_STATE
    GEN_EMAIL                               R_X509_LIB
    GEN_IPADD                               SENT_SHUTDOWN
    GEN_OTHERNAME                           SESSION_ASN1_VERSION
    GEN_RID                                 SESS_CACHE_BOTH
    GEN_URI                                 SESS_CACHE_CLIENT
    GEN_X400                                SESS_CACHE_NO_AUTO_CLEAR
    LIBRESSL_VERSION_NUMBER                 SESS_CACHE_NO_INTERNAL
    MBSTRING_ASC                            SESS_CACHE_NO_INTERNAL_LOOKUP
    MBSTRING_BMP                            SESS_CACHE_NO_INTERNAL_STORE
    MBSTRING_FLAG                           SESS_CACHE_OFF
    MBSTRING_UNIV                           SESS_CACHE_SERVER
    MBSTRING_UTF8                           SSL2_MT_CLIENT_CERTIFICATE
    MIN_RSA_MODULUS_LENGTH_IN_BYTES         SSL2_MT_CLIENT_FINISHED
    MODE_ACCEPT_MOVING_WRITE_BUFFER         SSL2_MT_CLIENT_HELLO
    MODE_AUTO_RETRY                         SSL2_MT_CLIENT_MASTER_KEY
    MODE_ENABLE_PARTIAL_WRITE               SSL2_MT_ERROR
    MODE_RELEASE_BUFFERS                    SSL2_MT_REQUEST_CERTIFICATE
    NID_OCSP_sign                           SSL2_MT_SERVER_FINISHED
    NID_SMIMECapabilities                   SSL2_MT_SERVER_HELLO
    NID_X500                                SSL2_MT_SERVER_VERIFY
    NID_X509                                SSL2_VERSION
    NID_ad_OCSP                             SSL3_MT_CCS
    NID_ad_ca_issuers                       SSL3_MT_CERTIFICATE
    NID_algorithm                           SSL3_MT_CERTIFICATE_REQUEST
    NID_authority_key_identifier            SSL3_MT_CERTIFICATE_STATUS
    NID_basic_constraints                   SSL3_MT_CERTIFICATE_URL
    NID_bf_cbc                              SSL3_MT_CERTIFICATE_VERIFY
    NID_bf_cfb64                            SSL3_MT_CHANGE_CIPHER_SPEC
    NID_bf_ecb                              SSL3_MT_CLIENT_HELLO
    NID_bf_ofb64                            SSL3_MT_CLIENT_KEY_EXCHANGE
    NID_cast5_cbc                           SSL3_MT_ENCRYPTED_EXTENSIONS
    NID_cast5_cfb64                         SSL3_MT_END_OF_EARLY_DATA
    NID_cast5_ecb                           SSL3_MT_FINISHED
    NID_cast5_ofb64                         SSL3_MT_HELLO_REQUEST
    NID_certBag                             SSL3_MT_KEY_UPDATE
    NID_certificate_policies                SSL3_MT_MESSAGE_HASH
    NID_client_auth                         SSL3_MT_NEWSESSION_TICKET
    NID_code_sign                           SSL3_MT_NEXT_PROTO
    NID_commonName                          SSL3_MT_SERVER_DONE
    NID_countryName                         SSL3_MT_SERVER_HELLO
    NID_crlBag                              SSL3_MT_SERVER_KEY_EXCHANGE
    NID_crl_distribution_points             SSL3_MT_SUPPLEMENTAL_DATA
    NID_crl_number                          SSL3_RT_ALERT
    NID_crl_reason                          SSL3_RT_APPLICATION_DATA
    NID_delta_crl                           SSL3_RT_CHANGE_CIPHER_SPEC
    NID_des_cbc                             SSL3_RT_HANDSHAKE
    NID_des_cfb64                           SSL3_RT_HEADER
    NID_des_ecb                             SSL3_RT_INNER_CONTENT_TYPE
    NID_des_ede                             SSL3_VERSION
    NID_des_ede3                            SSLEAY_BUILT_ON
    NID_des_ede3_cbc                        SSLEAY_CFLAGS
    NID_des_ede3_cfb64                      SSLEAY_DIR
    NID_des_ede3_ofb64                      SSLEAY_PLATFORM
    NID_des_ede_cbc                         SSLEAY_VERSION
    NID_des_ede_cfb64                       ST_ACCEPT
    NID_des_ede_ofb64                       ST_BEFORE
    NID_des_ofb64                           ST_CONNECT
    NID_description                         ST_INIT
    NID_desx_cbc                            ST_OK
    NID_dhKeyAgreement                      ST_READ_BODY
    NID_dnQualifier                         ST_READ_HEADER
    NID_dsa                                 TLS1_1_VERSION
    NID_dsaWithSHA                          TLS1_2_VERSION
    NID_dsaWithSHA1                         TLS1_3_VERSION
    NID_dsaWithSHA1_2                       TLS1_VERSION
    NID_dsa_2                               TLSEXT_STATUSTYPE_ocsp
    ...
    NID_idea_cfb64                          X509_FILETYPE_ASN1
    NID_idea_ecb                            X509_FILETYPE_DEFAULT
    NID_idea_ofb64                          X509_FILETYPE_PEM
    NID_info_access                         X509_LOOKUP
    NID_initials                            X509_PURPOSE_ANY
    NID_invalidity_date                     X509_PURPOSE_CRL_SIGN
    NID_issuer_alt_name                     X509_PURPOSE_NS_SSL_SERVER
    NID_keyBag                              X509_PURPOSE_OCSP_HELPER
    NID_key_usage                           X509_PURPOSE_SMIME_ENCRYPT
    NID_localKeyID                          X509_PURPOSE_SMIME_SIGN
    NID_localityName                        X509_PURPOSE_SSL_CLIENT
    NID_md2                                 X509_PURPOSE_SSL_SERVER
    NID_md2WithRSAEncryption                X509_PURPOSE_TIMESTAMP_SIGN
    NID_md5                                 X509_TRUST_COMPAT
    NID_md5WithRSA                          X509_TRUST_EMAIL
    NID_md5WithRSAEncryption                X509_TRUST_OBJECT_SIGN
    NID_md5_sha1                            X509_TRUST_OCSP_REQUEST
    NID_mdc2                                X509_TRUST_OCSP_SIGN
    NID_mdc2WithRSA                         X509_TRUST_SSL_CLIENT
    NID_ms_code_com                         X509_TRUST_SSL_SERVER
    NID_ms_code_ind                         X509_TRUST_TSA
    NID_ms_ctl_sign                         X509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH
    NID_ms_efs                              X509_V_ERR_AKID_SKID_MISMATCH
    NID_ms_ext_req                          X509_V_ERR_APPLICATION_VERIFICATION
    NID_ms_sgc                              X509_V_ERR_CA_KEY_TOO_SMALL
    NID_name                                X509_V_ERR_CA_MD_TOO_WEAK
    NID_netscape                            X509_V_ERR_CERT_CHAIN_TOO_LONG
    NID_netscape_base_url                   X509_V_ERR_CERT_HAS_EXPIRED
    NID_netscape_ca_policy_url              X509_V_ERR_CERT_NOT_YET_VALID
    NID_netscape_ca_revocation_url          X509_V_ERR_CERT_REJECTED
    NID_netscape_cert_extension             X509_V_ERR_CERT_REVOKED
    NID_netscape_cert_sequence              X509_V_ERR_CERT_SIGNATURE_FAILURE
    NID_netscape_cert_type                  X509_V_ERR_CERT_UNTRUSTED
    NID_netscape_comment                    X509_V_ERR_CRL_HAS_EXPIRED
    NID_netscape_data_type                  X509_V_ERR_CRL_NOT_YET_VALID
    NID_netscape_renewal_url                X509_V_ERR_CRL_PATH_VALIDATION_ERROR
    NID_netscape_revocation_url             X509_V_ERR_CRL_SIGNATURE_FAILURE
    NID_netscape_ssl_server_name            X509_V_ERR_DANE_NO_MATCH
    NID_ns_sgc                              X509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT
    NID_organizationName                    X509_V_ERR_DIFFERENT_CRL_SCOPE
    NID_organizationalUnitName              X509_V_ERR_EE_KEY_TOO_SMALL
    NID_pbeWithMD2AndDES_CBC                X509_V_ERR_EMAIL_MISMATCH
    NID_pbeWithMD2AndRC2_CBC                X509_V_ERR_ERROR_IN_CERT_NOT_AFTER_FIELD
    NID_pbeWithMD5AndCast5_CBC              X509_V_ERR_ERROR_IN_CERT_NOT_BEFORE_FIELD
    NID_pbeWithMD5AndDES_CBC                X509_V_ERR_ERROR_IN_CRL_LAST_UPDATE_FIELD
    NID_pbeWithMD5AndRC2_CBC                X509_V_ERR_ERROR_IN_CRL_NEXT_UPDATE_FIELD
    NID_pbeWithSHA1AndDES_CBC               X509_V_ERR_EXCLUDED_VIOLATION
    NID_pbeWithSHA1AndRC2_CBC               X509_V_ERR_HOSTNAME_MISMATCH
    NID_pbe_WithSHA1And128BitRC2_CBC        X509_V_ERR_INVALID_CA
    NID_pbe_WithSHA1And128BitRC4            X509_V_ERR_INVALID_CALL
    NID_pbe_WithSHA1And2_Key_TripleDES_CBC  X509_V_ERR_INVALID_EXTENSION
    NID_pbe_WithSHA1And3_Key_TripleDES_CBC  X509_V_ERR_INVALID_NON_CA
    NID_pbe_WithSHA1And40BitRC2_CBC         X509_V_ERR_INVALID_POLICY_EXTENSION
    NID_pbe_WithSHA1And40BitRC4             X509_V_ERR_INVALID_PURPOSE
    NID_pbes2                               X509_V_ERR_IP_ADDRESS_MISMATCH
    NID_pbmac1                              X509_V_ERR_KEYUSAGE_NO_CERTSIGN
    NID_pkcs                                X509_V_ERR_KEYUSAGE_NO_CRL_SIGN
    NID_pkcs3                               X509_V_ERR_KEYUSAGE_NO_DIGITAL_SIGNATURE
    NID_pkcs7                               X509_V_ERR_NO_EXPLICIT_POLICY
    NID_pkcs7_data                          X509_V_ERR_NO_VALID_SCTS
    NID_pkcs7_digest                        X509_V_ERR_OCSP_CERT_UNKNOWN
    NID_pkcs7_encrypted                     X509_V_ERR_OCSP_VERIFY_FAILED
    NID_pkcs7_enveloped                     X509_V_ERR_OCSP_VERIFY_NEEDED
    NID_pkcs7_signed                        X509_V_ERR_OUT_OF_MEM
    NID_pkcs7_signedAndEnveloped            X509_V_ERR_PATH_LENGTH_EXCEEDED
    NID_pkcs8ShroudedKeyBag                 X509_V_ERR_PATH_LOOP
    NID_pkcs9                               X509_V_ERR_PERMITTED_VIOLATION
    NID_pkcs9_challengePassword             X509_V_ERR_PROXY_CERTIFICATES_NOT_ALLOWED
    NID_pkcs9_contentType                   X509_V_ERR_PROXY_PATH_LENGTH_EXCEEDED
    NID_pkcs9_countersignature              X509_V_ERR_PROXY_SUBJECT_NAME_VIOLATION
    NID_pkcs9_emailAddress                  X509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN
    NID_pkcs9_extCertAttributes             X509_V_ERR_STORE_LOOKUP
    NID_pkcs9_messageDigest                 X509_V_ERR_SUBJECT_ISSUER_MISMATCH
    NID_pkcs9_signingTime                   X509_V_ERR_SUBTREE_MINMAX
    NID_pkcs9_unstructuredAddress           X509_V_ERR_SUITE_B_CANNOT_SIGN_P_384_WITH_P_256
    NID_pkcs9_unstructuredName              X509_V_ERR_SUITE_B_INVALID_ALGORITHM
    NID_private_key_usage_period            X509_V_ERR_SUITE_B_INVALID_CURVE
    NID_rc2_40_cbc                          X509_V_ERR_SUITE_B_INVALID_SIGNATURE_ALGORITHM
    NID_rc2_64_cbc                          X509_V_ERR_SUITE_B_INVALID_VERSION
    NID_rc2_cbc                             X509_V_ERR_SUITE_B_LOS_NOT_ALLOWED
    NID_rc2_cfb64                           X509_V_ERR_UNABLE_TO_DECODE_ISSUER_PUBLIC_KEY
    NID_rc2_ecb                             X509_V_ERR_UNABLE_TO_DECRYPT_CERT_SIGNATURE
    NID_rc2_ofb64                           X509_V_ERR_UNABLE_TO_DECRYPT_CRL_SIGNATURE
    NID_rc4                                 X509_V_ERR_UNABLE_TO_GET_CRL
    NID_rc4_40                              X509_V_ERR_UNABLE_TO_GET_CRL_ISSUER
    NID_rc5_cbc                             X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT
    NID_rc5_cfb64                           X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY
    NID_rc5_ecb                             X509_V_ERR_UNABLE_TO_VERIFY_LEAF_SIGNATURE
    NID_rc5_ofb64                           X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION
    NID_ripemd160                           X509_V_ERR_UNHANDLED_CRITICAL_EXTENSION
    NID_ripemd160WithRSA                    X509_V_ERR_UNNESTED_RESOURCE
    NID_rle_compression                     X509_V_ERR_UNSPECIFIED
    NID_rsa                                 X509_V_ERR_UNSUPPORTED_CONSTRAINT_SYNTAX
    NID_rsaEncryption                       X509_V_ERR_UNSUPPORTED_CONSTRAINT_TYPE
    NID_rsadsi                              X509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE
    NID_safeContentsBag                     X509_V_ERR_UNSUPPORTED_NAME_SYNTAX
    NID_sdsiCertificate                     X509_V_FLAG_ALLOW_PROXY_CERTS
    NID_secretBag                           X509_V_FLAG_CB_ISSUER_CHECK
    NID_serialNumber                        X509_V_FLAG_CHECK_SS_SIGNATURE
    NID_server_auth                         X509_V_FLAG_CRL_CHECK
    NID_sha                                 X509_V_FLAG_CRL_CHECK_ALL
    NID_sha1                                X509_V_FLAG_EXPLICIT_POLICY
    NID_sha1WithRSA                         X509_V_FLAG_EXTENDED_CRL_SUPPORT
    NID_sha1WithRSAEncryption               X509_V_FLAG_IGNORE_CRITICAL
    NID_shaWithRSAEncryption                X509_V_FLAG_INHIBIT_ANY
    NID_stateOrProvinceName                 X509_V_FLAG_INHIBIT_MAP
    NID_subject_alt_name                    X509_V_FLAG_LEGACY_VERIFY
    NID_subject_key_identifier              X509_V_FLAG_NOTIFY_POLICY
    NID_surname                             X509_V_FLAG_NO_ALT_CHAINS
    NID_sxnet                               X509_V_FLAG_NO_CHECK_TIME
    NID_time_stamp                          X509_V_FLAG_PARTIAL_CHAIN
    NID_title                               X509_V_FLAG_POLICY_CHECK
    NID_undef                               X509_V_FLAG_POLICY_MASK
    NID_uniqueIdentifier                    X509_V_FLAG_SUITEB_128_LOS
    NID_x509Certificate                     X509_V_FLAG_SUITEB_128_LOS_ONLY
    NID_x509Crl                             X509_V_FLAG_SUITEB_192_LOS
    NID_zlib_compression                    X509_V_FLAG_TRUSTED_FIRST
    NOTHING                                 X509_V_FLAG_USE_CHECK_TIME
    OCSP_RESPONSE_STATUS_INTERNALERROR      X509_V_FLAG_USE_DELTAS
    OCSP_RESPONSE_STATUS_MALFORMEDREQUEST   X509_V_FLAG_X509_STRICT
    OCSP_RESPONSE_STATUS_SIGREQUIRED        X509_V_OK
    OCSP_RESPONSE_STATUS_SUCCESSFUL         XN_FLAG_COMPAT
    OCSP_RESPONSE_STATUS_TRYLATER           XN_FLAG_DN_REV
    OCSP_RESPONSE_STATUS_UNAUTHORIZED       XN_FLAG_DUMP_UNKNOWN_FIELDS
    OPENSSL_BUILT_ON                        XN_FLAG_FN_ALIGN
    OPENSSL_CFLAGS                          XN_FLAG_FN_LN
    OPENSSL_CPU_INFO                        XN_FLAG_FN_MASK
    OPENSSL_DIR                             XN_FLAG_FN_NONE
    OPENSSL_ENGINES_DIR                     XN_FLAG_FN_OID
    OPENSSL_FULL_VERSION_STRING             XN_FLAG_FN_SN
    OPENSSL_MODULES_DIR                     XN_FLAG_MULTILINE
    OPENSSL_PLATFORM                        XN_FLAG_ONELINE
    OPENSSL_VERSION                         XN_FLAG_RFC2253
    OPENSSL_VERSION_NUMBER                  XN_FLAG_SEP_COMMA_PLUS
    OPENSSL_VERSION_STRING                  XN_FLAG_SEP_CPLUS_SPC
    OP_ALL                                  XN_FLAG_SEP_MASK
    OP_ALLOW_NO_DHE_KEX                     XN_FLAG_SEP_MULTILINE
    OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION    XN_FLAG_SEP_SPLUS_SPC
    OP_CIPHER_SERVER_PREFERENCE             XN_FLAG_SPC_EQ
