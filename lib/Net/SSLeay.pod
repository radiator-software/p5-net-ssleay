...
=for start_constants
    ...
    ASN1_STRFLGS_ESC_CTRL                   OCSP_RESPONSE_STATUS_MALFORMEDREQUEST
    ASN1_STRFLGS_ESC_MSB                    OCSP_RESPONSE_STATUS_SIGREQUIRED
    ASN1_STRFLGS_ESC_QUOTE                  OCSP_RESPONSE_STATUS_SUCCESSFUL
    ASN1_STRFLGS_RFC2253                    OCSP_RESPONSE_STATUS_TRYLATER
    CB_ACCEPT_EXIT                          OCSP_RESPONSE_STATUS_UNAUTHORIZED
    CB_ACCEPT_LOOP                          OPENSSL_BUILT_ON
    CB_ALERT                                OPENSSL_CFLAGS
    CB_CONNECT_EXIT                         OPENSSL_DIR
    CB_CONNECT_LOOP                         OPENSSL_ENGINES_DIR
    CB_EXIT                                 OPENSSL_PLATFORM
    CB_HANDSHAKE_DONE                       OPENSSL_VERSION
    CB_HANDSHAKE_START                      OPENSSL_VERSION_NUMBER
    CB_LOOP                                 OP_ALL
    CB_READ                                 OP_ALLOW_NO_DHE_KEX
    CB_READ_ALERT                           OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION
    CB_WRITE                                OP_CIPHER_SERVER_PREFERENCE
    CB_WRITE_ALERT                          OP_CISCO_ANYCONNECT
    ERROR_NONE                              OP_COOKIE_EXCHANGE
    ERROR_SSL                               OP_CRYPTOPRO_TLSEXT_BUG
    ERROR_SYSCALL                           OP_DONT_INSERT_EMPTY_FRAGMENTS
    ERROR_WANT_ACCEPT                       OP_ENABLE_MIDDLEBOX_COMPAT
    ERROR_WANT_CONNECT                      OP_EPHEMERAL_RSA
    ERROR_WANT_READ                         OP_LEGACY_SERVER_CONNECT
    ERROR_WANT_WRITE                        OP_MICROSOFT_BIG_SSLV3_BUFFER
    ERROR_WANT_X509_LOOKUP                  OP_MICROSOFT_SESS_ID_BUG
    ERROR_ZERO_RETURN                       OP_MSIE_SSLV2_RSA_PADDING
    EVP_PKS_DSA                             OP_NETSCAPE_CA_DN_BUG
    EVP_PKS_EC                              OP_NETSCAPE_CHALLENGE_BUG
    EVP_PKS_RSA                             OP_NETSCAPE_DEMO_CIPHER_CHANGE_BUG
    EVP_PKT_ENC                             OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG
    EVP_PKT_EXCH                            OP_NON_EXPORT_FIRST
    EVP_PKT_EXP                             OP_NO_ANTI_REPLAY
    EVP_PKT_SIGN                            OP_NO_CLIENT_RENEGOTIATION
    EVP_PK_DH                               OP_NO_COMPRESSION
    EVP_PK_DSA                              OP_NO_ENCRYPT_THEN_MAC
    EVP_PK_EC                               OP_NO_QUERY_MTU
    EVP_PK_RSA                              OP_NO_RENEGOTIATION
    FILETYPE_ASN1                           OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION
    FILETYPE_PEM                            OP_NO_SSL_MASK
    F_CLIENT_CERTIFICATE                    OP_NO_SSLv2
    F_CLIENT_HELLO                          OP_NO_SSLv3
    F_CLIENT_MASTER_KEY                     OP_NO_TICKET
    F_D2I_SSL_SESSION                       OP_NO_TLSv1
    F_GET_CLIENT_FINISHED                   OP_NO_TLSv1_1
    F_GET_CLIENT_HELLO                      OP_NO_TLSv1_2
    F_GET_CLIENT_MASTER_KEY                 OP_NO_TLSv1_3
    F_GET_SERVER_FINISHED                   OP_PKCS1_CHECK_1
    F_GET_SERVER_HELLO                      OP_PKCS1_CHECK_2
    F_GET_SERVER_VERIFY                     OP_PRIORITIZE_CHACHA
    F_I2D_SSL_SESSION                       OP_SAFARI_ECDHE_ECDSA_BUG
    F_READ_N                                OP_SINGLE_DH_USE
    F_REQUEST_CERTIFICATE                   OP_SINGLE_ECDH_USE
    F_SERVER_HELLO                          OP_SSLEAY_080_CLIENT_DH_BUG
    F_SSL_CERT_NEW                          OP_SSLREF2_REUSE_CERT_TYPE_BUG
    F_SSL_GET_NEW_SESSION                   OP_TLSEXT_PADDING
    F_SSL_NEW                               OP_TLS_BLOCK_PADDING_BUG
    F_SSL_READ                              OP_TLS_D5_BUG
    F_SSL_RSA_PRIVATE_DECRYPT               OP_TLS_ROLLBACK_BUG
    F_SSL_RSA_PUBLIC_ENCRYPT                READING
    F_SSL_SESSION_NEW                       RECEIVED_SHUTDOWN
    F_SSL_SESSION_PRINT_FP                  RSA_3
    F_SSL_SET_FD                            RSA_F4
    F_SSL_SET_RFD                           R_BAD_AUTHENTICATION_TYPE
    F_SSL_SET_WFD                           R_BAD_CHECKSUM
    F_SSL_USE_CERTIFICATE                   R_BAD_MAC_DECODE
    F_SSL_USE_CERTIFICATE_ASN1              R_BAD_RESPONSE_ARGUMENT
    F_SSL_USE_CERTIFICATE_FILE              R_BAD_SSL_FILETYPE
    F_SSL_USE_PRIVATEKEY                    R_BAD_SSL_SESSION_ID_LENGTH
    F_SSL_USE_PRIVATEKEY_ASN1               R_BAD_STATE
    F_SSL_USE_PRIVATEKEY_FILE               R_BAD_WRITE_RETRY
    F_SSL_USE_RSAPRIVATEKEY                 R_CHALLENGE_IS_DIFFERENT
    F_SSL_USE_RSAPRIVATEKEY_ASN1            R_CIPHER_TABLE_SRC_ERROR
    F_SSL_USE_RSAPRIVATEKEY_FILE            R_INVALID_CHALLENGE_LENGTH
    F_WRITE_PENDING                         R_NO_CERTIFICATE_SET
    GEN_DIRNAME                             R_NO_CERTIFICATE_SPECIFIED
    GEN_DNS                                 R_NO_CIPHER_LIST
    GEN_EDIPARTY                            R_NO_CIPHER_MATCH
    GEN_EMAIL                               R_NO_PRIVATEKEY
    GEN_IPADD                               R_NO_PUBLICKEY
    GEN_OTHERNAME                           R_NULL_SSL_CTX
    GEN_RID                                 R_PEER_DID_NOT_RETURN_A_CERTIFICATE
    GEN_URI                                 R_PEER_ERROR
    GEN_X400                                R_PEER_ERROR_CERTIFICATE
    LIBRESSL_VERSION_NUMBER                 R_PEER_ERROR_NO_CIPHER
    MBSTRING_ASC                            R_PEER_ERROR_UNSUPPORTED_CERTIFICATE_TYPE
    MBSTRING_BMP                            R_PUBLIC_KEY_ENCRYPT_ERROR
    MBSTRING_FLAG                           R_PUBLIC_KEY_IS_NOT_RSA
    MBSTRING_UNIV                           R_READ_WRONG_PACKET_TYPE
    MBSTRING_UTF8                           R_SHORT_READ
    MIN_RSA_MODULUS_LENGTH_IN_BYTES         R_SSL_SESSION_ID_IS_DIFFERENT
    MODE_ACCEPT_MOVING_WRITE_BUFFER         R_UNABLE_TO_EXTRACT_PUBLIC_KEY
    MODE_AUTO_RETRY                         R_UNKNOWN_REMOTE_ERROR_TYPE
    MODE_ENABLE_PARTIAL_WRITE               R_UNKNOWN_STATE
    MODE_RELEASE_BUFFERS                    R_X509_LIB
    NID_OCSP_sign                           SENT_SHUTDOWN
    NID_SMIMECapabilities                   SESSION_ASN1_VERSION
    NID_X500                                SESS_CACHE_BOTH
    NID_X509                                SESS_CACHE_CLIENT
    NID_ad_OCSP                             SESS_CACHE_NO_AUTO_CLEAR
    NID_ad_ca_issuers                       SESS_CACHE_NO_INTERNAL
    NID_algorithm                           SESS_CACHE_NO_INTERNAL_LOOKUP
    NID_authority_key_identifier            SESS_CACHE_NO_INTERNAL_STORE
    NID_basic_constraints                   SESS_CACHE_OFF
    NID_bf_cbc                              SESS_CACHE_SERVER
    NID_bf_cfb64                            SSL3_VERSION
    NID_bf_ecb                              SSLEAY_BUILT_ON
    NID_bf_ofb64                            SSLEAY_CFLAGS
    NID_cast5_cbc                           SSLEAY_DIR
    NID_cast5_cfb64                         SSLEAY_PLATFORM
    NID_cast5_ecb                           SSLEAY_VERSION
    NID_cast5_ofb64                         ST_ACCEPT
    NID_certBag                             ST_BEFORE
    NID_certificate_policies                ST_CONNECT
    NID_client_auth                         ST_INIT
    NID_code_sign                           ST_OK
    NID_commonName                          ST_READ_BODY
    NID_countryName                         ST_READ_HEADER
    NID_crlBag                              TLS1_1_VERSION
    NID_crl_distribution_points             TLS1_2_VERSION
    NID_crl_number                          TLS1_3_VERSION
    NID_crl_reason                          TLS1_VERSION
    NID_delta_crl                           TLSEXT_STATUSTYPE_ocsp
    NID_des_cbc                             VERIFY_CLIENT_ONCE
    NID_des_cfb64                           VERIFY_FAIL_IF_NO_PEER_CERT
    NID_des_ecb                             VERIFY_NONE
    NID_des_ede                             VERIFY_PEER
    NID_des_ede3                            VERIFY_POST_HANDSHAKE
    NID_des_ede3_cbc                        V_OCSP_CERTSTATUS_GOOD
    NID_des_ede3_cfb64                      V_OCSP_CERTSTATUS_REVOKED
    NID_des_ede3_ofb64                      V_OCSP_CERTSTATUS_UNKNOWN
    NID_des_ede_cbc                         WRITING
    NID_des_ede_cfb64                       X509_CHECK_FLAG_ALWAYS_CHECK_SUBJECT
    NID_des_ede_ofb64                       X509_CHECK_FLAG_MULTI_LABEL_WILDCARDS
    NID_des_ofb64                           X509_CHECK_FLAG_NEVER_CHECK_SUBJECT
    NID_description                         X509_CHECK_FLAG_NO_PARTIAL_WILDCARDS
    NID_desx_cbc                            X509_CHECK_FLAG_NO_WILDCARDS
    NID_dhKeyAgreement                      X509_CHECK_FLAG_SINGLE_LABEL_SUBDOMAINS
    NID_dnQualifier                         X509_FILETYPE_ASN1
    NID_dsa                                 X509_FILETYPE_DEFAULT
    NID_dsaWithSHA                          X509_FILETYPE_PEM
    NID_dsaWithSHA1                         X509_LOOKUP
    NID_dsaWithSHA1_2                       X509_PURPOSE_ANY
    NID_dsa_2                               X509_PURPOSE_CRL_SIGN
    NID_email_protect                       X509_PURPOSE_NS_SSL_SERVER
    NID_ext_key_usage                       X509_PURPOSE_OCSP_HELPER
    NID_ext_req                             X509_PURPOSE_SMIME_ENCRYPT
    NID_friendlyName                        X509_PURPOSE_SMIME_SIGN
    NID_givenName                           X509_PURPOSE_SSL_CLIENT
    NID_hmacWithSHA1                        X509_PURPOSE_SSL_SERVER
    NID_id_ad                               X509_PURPOSE_TIMESTAMP_SIGN
    NID_id_ce                               X509_TRUST_COMPAT
    NID_id_kp                               X509_TRUST_EMAIL
    NID_id_pbkdf2                           X509_TRUST_OBJECT_SIGN
    NID_id_pe                               X509_TRUST_OCSP_REQUEST
    NID_id_pkix                             X509_TRUST_OCSP_SIGN
    NID_id_qt_cps                           X509_TRUST_SSL_CLIENT
    NID_id_qt_unotice                       X509_TRUST_SSL_SERVER
    NID_idea_cbc                            X509_TRUST_TSA
    NID_idea_cfb64                          X509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH
    NID_idea_ecb                            X509_V_ERR_AKID_SKID_MISMATCH
    NID_idea_ofb64                          X509_V_ERR_APPLICATION_VERIFICATION
    NID_info_access                         X509_V_ERR_CA_KEY_TOO_SMALL
    NID_initials                            X509_V_ERR_CA_MD_TOO_WEAK
    NID_invalidity_date                     X509_V_ERR_CERT_CHAIN_TOO_LONG
    NID_issuer_alt_name                     X509_V_ERR_CERT_HAS_EXPIRED
    NID_keyBag                              X509_V_ERR_CERT_NOT_YET_VALID
    NID_key_usage                           X509_V_ERR_CERT_REJECTED
    NID_localKeyID                          X509_V_ERR_CERT_REVOKED
    NID_localityName                        X509_V_ERR_CERT_SIGNATURE_FAILURE
    NID_md2                                 X509_V_ERR_CERT_UNTRUSTED
    NID_md2WithRSAEncryption                X509_V_ERR_CRL_HAS_EXPIRED
    NID_md5                                 X509_V_ERR_CRL_NOT_YET_VALID
    NID_md5WithRSA                          X509_V_ERR_CRL_PATH_VALIDATION_ERROR
    NID_md5WithRSAEncryption                X509_V_ERR_CRL_SIGNATURE_FAILURE
    NID_md5_sha1                            X509_V_ERR_DANE_NO_MATCH
    NID_mdc2                                X509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT
    NID_mdc2WithRSA                         X509_V_ERR_DIFFERENT_CRL_SCOPE
    NID_ms_code_com                         X509_V_ERR_EE_KEY_TOO_SMALL
    NID_ms_code_ind                         X509_V_ERR_EMAIL_MISMATCH
    NID_ms_ctl_sign                         X509_V_ERR_ERROR_IN_CERT_NOT_AFTER_FIELD
    NID_ms_efs                              X509_V_ERR_ERROR_IN_CERT_NOT_BEFORE_FIELD
    NID_ms_ext_req                          X509_V_ERR_ERROR_IN_CRL_LAST_UPDATE_FIELD
    NID_ms_sgc                              X509_V_ERR_ERROR_IN_CRL_NEXT_UPDATE_FIELD
    NID_name                                X509_V_ERR_EXCLUDED_VIOLATION
    NID_netscape                            X509_V_ERR_HOSTNAME_MISMATCH
    NID_netscape_base_url                   X509_V_ERR_INVALID_CA
    NID_netscape_ca_policy_url              X509_V_ERR_INVALID_CALL
    NID_netscape_ca_revocation_url          X509_V_ERR_INVALID_EXTENSION
    NID_netscape_cert_extension             X509_V_ERR_INVALID_NON_CA
    NID_netscape_cert_sequence              X509_V_ERR_INVALID_POLICY_EXTENSION
    NID_netscape_cert_type                  X509_V_ERR_INVALID_PURPOSE
    NID_netscape_comment                    X509_V_ERR_IP_ADDRESS_MISMATCH
    NID_netscape_data_type                  X509_V_ERR_KEYUSAGE_NO_CERTSIGN
    NID_netscape_renewal_url                X509_V_ERR_KEYUSAGE_NO_CRL_SIGN
    NID_netscape_revocation_url             X509_V_ERR_KEYUSAGE_NO_DIGITAL_SIGNATURE
    NID_netscape_ssl_server_name            X509_V_ERR_NO_EXPLICIT_POLICY
    NID_ns_sgc                              X509_V_ERR_NO_VALID_SCTS
    NID_organizationName                    X509_V_ERR_OCSP_CERT_UNKNOWN
    NID_organizationalUnitName              X509_V_ERR_OCSP_VERIFY_FAILED
    NID_pbeWithMD2AndDES_CBC                X509_V_ERR_OCSP_VERIFY_NEEDED
    NID_pbeWithMD2AndRC2_CBC                X509_V_ERR_OUT_OF_MEM
    NID_pbeWithMD5AndCast5_CBC              X509_V_ERR_PATH_LENGTH_EXCEEDED
    NID_pbeWithMD5AndDES_CBC                X509_V_ERR_PATH_LOOP
    NID_pbeWithMD5AndRC2_CBC                X509_V_ERR_PERMITTED_VIOLATION
    NID_pbeWithSHA1AndDES_CBC               X509_V_ERR_PROXY_CERTIFICATES_NOT_ALLOWED
    NID_pbeWithSHA1AndRC2_CBC               X509_V_ERR_PROXY_PATH_LENGTH_EXCEEDED
    NID_pbe_WithSHA1And128BitRC2_CBC        X509_V_ERR_PROXY_SUBJECT_NAME_VIOLATION
    NID_pbe_WithSHA1And128BitRC4            X509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN
    NID_pbe_WithSHA1And2_Key_TripleDES_CBC  X509_V_ERR_STORE_LOOKUP
    NID_pbe_WithSHA1And3_Key_TripleDES_CBC  X509_V_ERR_SUBJECT_ISSUER_MISMATCH
    NID_pbe_WithSHA1And40BitRC2_CBC         X509_V_ERR_SUBTREE_MINMAX
    NID_pbe_WithSHA1And40BitRC4             X509_V_ERR_SUITE_B_CANNOT_SIGN_P_384_WITH_P_256
    NID_pbes2                               X509_V_ERR_SUITE_B_INVALID_ALGORITHM
    NID_pbmac1                              X509_V_ERR_SUITE_B_INVALID_CURVE
    NID_pkcs                                X509_V_ERR_SUITE_B_INVALID_SIGNATURE_ALGORITHM
    NID_pkcs3                               X509_V_ERR_SUITE_B_INVALID_VERSION
    NID_pkcs7                               X509_V_ERR_SUITE_B_LOS_NOT_ALLOWED
    NID_pkcs7_data                          X509_V_ERR_UNABLE_TO_DECODE_ISSUER_PUBLIC_KEY
    NID_pkcs7_digest                        X509_V_ERR_UNABLE_TO_DECRYPT_CERT_SIGNATURE
    NID_pkcs7_encrypted                     X509_V_ERR_UNABLE_TO_DECRYPT_CRL_SIGNATURE
    NID_pkcs7_enveloped                     X509_V_ERR_UNABLE_TO_GET_CRL
    NID_pkcs7_signed                        X509_V_ERR_UNABLE_TO_GET_CRL_ISSUER
    NID_pkcs7_signedAndEnveloped            X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT
    NID_pkcs8ShroudedKeyBag                 X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY
    NID_pkcs9                               X509_V_ERR_UNABLE_TO_VERIFY_LEAF_SIGNATURE
    NID_pkcs9_challengePassword             X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION
    NID_pkcs9_contentType                   X509_V_ERR_UNHANDLED_CRITICAL_EXTENSION
    NID_pkcs9_countersignature              X509_V_ERR_UNNESTED_RESOURCE
    NID_pkcs9_emailAddress                  X509_V_ERR_UNSPECIFIED
    NID_pkcs9_extCertAttributes             X509_V_ERR_UNSUPPORTED_CONSTRAINT_SYNTAX
    NID_pkcs9_messageDigest                 X509_V_ERR_UNSUPPORTED_CONSTRAINT_TYPE
    NID_pkcs9_signingTime                   X509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE
    NID_pkcs9_unstructuredAddress           X509_V_ERR_UNSUPPORTED_NAME_SYNTAX
    NID_pkcs9_unstructuredName              X509_V_FLAG_ALLOW_PROXY_CERTS
    NID_private_key_usage_period            X509_V_FLAG_CB_ISSUER_CHECK
    NID_rc2_40_cbc                          X509_V_FLAG_CHECK_SS_SIGNATURE
    NID_rc2_64_cbc                          X509_V_FLAG_CRL_CHECK
    NID_rc2_cbc                             X509_V_FLAG_CRL_CHECK_ALL
    NID_rc2_cfb64                           X509_V_FLAG_EXPLICIT_POLICY
    NID_rc2_ecb                             X509_V_FLAG_EXTENDED_CRL_SUPPORT
    NID_rc2_ofb64                           X509_V_FLAG_IGNORE_CRITICAL
    NID_rc4                                 X509_V_FLAG_INHIBIT_ANY
    NID_rc4_40                              X509_V_FLAG_INHIBIT_MAP
    NID_rc5_cbc                             X509_V_FLAG_LEGACY_VERIFY
    NID_rc5_cfb64                           X509_V_FLAG_NOTIFY_POLICY
    NID_rc5_ecb                             X509_V_FLAG_NO_ALT_CHAINS
    NID_rc5_ofb64                           X509_V_FLAG_NO_CHECK_TIME
    NID_ripemd160                           X509_V_FLAG_PARTIAL_CHAIN
    NID_ripemd160WithRSA                    X509_V_FLAG_POLICY_CHECK
    NID_rle_compression                     X509_V_FLAG_POLICY_MASK
    NID_rsa                                 X509_V_FLAG_SUITEB_128_LOS
    NID_rsaEncryption                       X509_V_FLAG_SUITEB_128_LOS_ONLY
    NID_rsadsi                              X509_V_FLAG_SUITEB_192_LOS
    NID_safeContentsBag                     X509_V_FLAG_TRUSTED_FIRST
    NID_sdsiCertificate                     X509_V_FLAG_USE_CHECK_TIME
    NID_secretBag                           X509_V_FLAG_USE_DELTAS
    NID_serialNumber                        X509_V_FLAG_X509_STRICT
    NID_server_auth                         X509_V_OK
    NID_sha                                 XN_FLAG_COMPAT
    NID_sha1                                XN_FLAG_DN_REV
    NID_sha1WithRSA                         XN_FLAG_DUMP_UNKNOWN_FIELDS
    NID_sha1WithRSAEncryption               XN_FLAG_FN_ALIGN
    NID_shaWithRSAEncryption                XN_FLAG_FN_LN
    NID_stateOrProvinceName                 XN_FLAG_FN_MASK
    NID_subject_alt_name                    XN_FLAG_FN_NONE
    NID_subject_key_identifier              XN_FLAG_FN_OID
    NID_surname                             XN_FLAG_FN_SN
    NID_sxnet                               XN_FLAG_MULTILINE
    NID_time_stamp                          XN_FLAG_ONELINE
    NID_title                               XN_FLAG_RFC2253
    NID_undef                               XN_FLAG_SEP_COMMA_PLUS
    NID_uniqueIdentifier                    XN_FLAG_SEP_CPLUS_SPC
    NID_x509Certificate                     XN_FLAG_SEP_MASK
    NID_x509Crl                             XN_FLAG_SEP_MULTILINE
    NID_zlib_compression                    XN_FLAG_SEP_SPLUS_SPC
    NOTHING                                 XN_FLAG_SPC_EQ
